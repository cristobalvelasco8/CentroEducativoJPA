...
public class PanelProfesores extends JPanel {
		...
		public void initialize () {
			...
			btnPrimero.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/primero.png")));
			toolBar.add(btnPrimero);
			
			JButton btnAnterior = new JButton("");
			btnAnterior.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/anterior.png")));
			...
			btnSiguiente.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/siguiente.png")));
			...
			btnUltimo.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/ultimo.png")));
			...
			btnGuardar.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/guardar.png")));
			...
			btnNuevo.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/nuevo.png")));
			...
			btnEliminar.setIcon(new ImageIcon(PanelProfesores.class.getResource("/fotos/basura.png")));
